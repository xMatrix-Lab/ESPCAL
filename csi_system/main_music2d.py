...
# from core.csi_core_double import CSIDataGUI
...
from algorithms.music_2d import Music2D
from algorithms.music_2d_true import Music2D_True
from algorithms.CIR_sync import CIRSync
from algorithms.RSSI_weighting import RSSIWeighting
from tabs.tab_music_2d import AOA2DTab
from tabs.tab_music_2d_carame import MUSIC2D_Carame_Tab
...
class MyCSIApp(CSIDataGUI):  
    ...
    def _init_algorithms(self):
        ...
        music_2d = Music2D()
        self.register_algorithm('aoa_2d', music_2d)

    def _init_tabs(self):
        """初始化 Tab 页"""
        # 注册 AOA 2D 显示 Tab
        self.register_tab('AoA 2D', AOA2DTab, enabled=True)
        self.register_tab('MUSIC 2D Carame', MUSIC2D_Carame_Tab, enabled=False)
